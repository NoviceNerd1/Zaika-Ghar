...
//   useEffect(() => {
//     console.log("Current searchedRestaurant state:", searchedRestaurant);
//   }, [searchedRestaurant]);

//   // Test loading all restaurants on component mount
//   useEffect(() => {
...
//   // Load all restaurants by default when component mounts
//   useEffect(() => {
//     const loadDefaultRestaurants = async () => {
//       if (!searchText) {
//         // If no search text, show all restaurants
//         await searchRestaurant("", "", appliedFilter);
//       } else {
...
//   }, [searchText, searchQuery, appliedFilter, searchRestaurant]);
...
//     appliedFilter.forEach((filter) => setAppliedFilter(filter));
//   };
...
//           <div className="flex-1">
//             {/* Search Header */}
//             <div className="bg-white dark:bg-gray-800 rounded-3xl p-8 mb-8 shadow-xl border border-gray-100 dark:border-gray-700">
...
//                 <Button
//                   onClick={handleSearch}
//                   className="bg-orange hover:bg-hoverOrange py-4 px-8 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 transform hover:-translate-y-0.5 min-w-[120px]"
//                 >
//                   <Search className="w-5 h-5 mr-2" />
//                   Search
//                 </Button>
...
//               {/* Quick Stats */}
//               {searchedRestaurant?.data && (
//                 <div className="flex flex-wrap gap-6 mt-6 pt-6 border-t border-gray-200 dark:border-gray-600">
//                   <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
//                     <Users className="w-4 h-4" />
//                     <span className="text-sm font-medium">
//                       {searchedRestaurant.data.length} restaurants
//                     </span>
//                   </div>
//                   {appliedFilter.length > 0 && (
//                     <div className="flex items-center gap-2 text-gray-600 dark:text-gray-400">
//                       <span className="text-sm font-medium">
//                         {appliedFilter.length} active filters
//                       </span>
//                     </div>
//                   )}
//                 </div>
...
//                   >
//                     {searchedRestaurant?.data?.length || 0} found
//                   </Badge>
//                 </div>
...
//                             >
//                               <Badge
//                                 className="bg-orange/10 text-orange border-orange/20 hover:bg-orange/20 transition-all duration-200 rounded-full pl-4 pr-8 py-2 font-medium shadow-sm group-hover:scale-105"
//                                 variant="outline"
//                               >
//                                 {selectedFilter}
//                               </Badge>
...
//                         className="text-gray-500 hover:text-gray-700 border-gray-300 rounded-xl"
//                         size="sm"
//                       >
//                         Clear All
//                       </Button>
...
//         {/* Top Badges */}
//         <div className="absolute top-4 left-4 flex flex-col gap-2">
//           <Badge className="bg-white/95 dark:bg-gray-800/95 text-gray-700 dark:text-gray-300 font-semibold px-3 py-2 rounded-full shadow-lg backdrop-blur-sm border-0">
//             <Star className="w-3 h-3 mr-1 fill-current text-yellow-500" />
//             Featured
//           </Badge>
//         </div>
...
//       <div className="w-32 h-32 bg-orange/10 rounded-full flex items-center justify-center mb-8">
//         <Search className="w-16 h-16 text-orange" />
//       </div>
//       <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
//         No restaurants found
//       </h2>
//       <p className="text-gray-600 dark:text-gray-400 text-lg mb-4 max-w-md">
//         {searchText || searchQuery ? (
//           <>
//             We couldn't find any results for{" "}
//             <span className="font-semibold text-orange">
...
//       <div className="flex flex-col sm:flex-row gap-4">
//         <Link to="/search">
//           <Button className="bg-orange hover:bg-hoverOrange px-8 py-4 rounded-2xl font-semibold shadow-lg hover:shadow-xl transition-all duration-200 text-base">
//             Explore All Restaurants
//           </Button>
//         </Link>
//         <Button
//           variant="outline"
//           className="px-8 py-4 rounded-2xl font-semibold border-2 text-base"
//           onClick={() => window.location.reload()}
//         >
//           Refresh Page
//         </Button>
